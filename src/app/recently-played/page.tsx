  ...
  return (
    <div className="min-h-screen px-4 md:px-8 py-6 md:py-8">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-bold text-text-primary tracking-tight">Recently Played</h1>
      ...
      {recentSongs.length === 0 ? (
        ...
        >
          ...
          <div className="text-center max-w-xs">
            <p className="text-sm font-medium text-text-primary">No recently played songs</p>
            <p className="text-xs text-text-secondary mt-1">Start playing songs to build your history</p>
          </div>
        </motion.div>
      ) : (
