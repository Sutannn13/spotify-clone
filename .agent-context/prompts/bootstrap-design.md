...
```json
{
  ...
  "aiSafeUiAudit": {
    ...
    "interchangeabilityTest": "If this UI can be renamed from spoti clone to another product category without changing composition, palette, iconography, and motion, revise it.",
  ...
  "designExecutionHandoff": {
    ...
    "primaryExperienceGoal": "Define the main fullstack product journey for spoti clone from repo evidence, brief, and docs.",
    "surfacePlan": [
      {
    ...
    "taskFlowNarrative": [
      "Entry: start spoti clone from real evidence, not a generic opener.",
